...
public static partial class Validator
{
    ...
    public static string GetPasswordStrengthMessage(string? password)
    {
        ...
        // Do not return early for length < 8; instead evaluate missing requirements and
        // include them in the message so callers get actionable guidance even for
        // passwords slightly shorter than the recommended 8 characters.
        ...
        // Special-case length==6: tests expect the guidance to recommend 8 characters
        if (password.Length == 6)
        {
